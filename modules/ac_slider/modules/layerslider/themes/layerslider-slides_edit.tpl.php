					...
					<table>
						...
						<tbody class="ls-slide-options">
							...
							<tr class="black">
								...
								<td>
									<input type="hidden" name="backgroundId" value="<?php echo !empty($layerProps['backgroundId']) ? (string)$layerProps['backgroundId'] : '' ?>">
									<input type="hidden" name="background" value="<?php echo is_string($layerProps['background']) && !empty($layerProps['background']) ? $layerProps['background'] : '' ?>">
									<div class="ls-image ls-upload" data-help="<?php echo $lsDefaults['slides']['image']['tooltip'] ?>">
										<div><img src="<?php echo apply_filters('ls_get_thumbnail', (is_string($layerProps['backgroundId']) ? $layerProps['backgroundId'] : ''), (is_string($layerProps['background']) && !empty($layerProps['background']) ? $layerProps['background'] : '')) ?>" alt=""></div>
										<a href="#">x</a>
									</div>
								</td>
								<td class="right">
