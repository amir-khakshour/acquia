<div id="ac-megamenu-admin-mm-toolitem" class="admin-toolbox">
  ...
  <ul>
    <li class="font-icon-search" title="<?php print t('Icon') . ' - ' . t('Add Icon for Menu Item. Click Icon label to visit Bootstrap icons page and get Icon Class. E.g.: icon-search') ?>">
      <label class="hasTip">
        <?php print t('Icon') ?>
      </label>
      <fieldset class="">
        <input type="text" class="input-medium toolitem-xicon toolbox-input" name="toolitem-xicon" data-name="xicon" value="" />
        <a class="ico-btn ac-fonticon-sel" href="#" title="<?php print t('select font icon')?>"><i class="icon-search"></i></a>
      </fieldset>
    </li>
  </ul>
  <ul>
