<div id="ac-megamenu-admin-mm-toolcol" class="admin-toolbox">
  ...
  <ul>
    <li id="ac-megamenu-grid-wrapper" title="<?php print t('Grid (1-12)') . ' - ' . t('Set number of grid columns the selected column spans') ?>">
  ...
  <ul>
    <li id="ac-megamenu-block-wrapper" title="<?php print t('Blocks') . ' - ' . t('Add/replace a block to the selected column') ?>">
